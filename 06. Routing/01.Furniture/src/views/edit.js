...
import { editItem, getById } from '../data.js';
...
<div class="row space-top">
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="new-description" type="text" name="description" .value=${item.descriptions}>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
...
export function editPage(ctx) {
    ...
    function update(itemPromise, errorMsg, errors) {
        ...
        ctx.render(editTemplate(loadIdem(itemPromise)));
    }

    async function loadIdem(itemPromise) {
